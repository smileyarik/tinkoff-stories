...
python make_features.py ../data/tr_user_pickle.bin ../data/tr_item_pickle.bin train "2018-07-01 00:00:00" ../data/tr_tg_reactions.csv ../data/tr_features_$ver.txt ../data/tr_model_$nnver.bin ../src_data/customer_test.csv ../data/all_story_id.txt
python make_features.py ../data/vl_user_pickle.bin ../data/vl_item_pickle.bin train "2018-07-16 00:00:00" ../data/vl_tg_reactions.csv ../data/vl_features_$ver.txt ../data/vl_model_$nnver.bin ../src_data/customer_test.csv ../data/all_story_id.txt
python make_features.py ../data/tt_user_pickle.bin ../data/tt_item_pickle.bin testt "2018-08-01 00:00:00" ../src_data/stories_reaction_test.csv ../data/tt_features_$ver.txt ../data/tt_model_$nnver.bin ../src_data/customer_test.csv ../data/all_story_id.txt
