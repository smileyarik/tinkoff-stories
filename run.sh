...
#python learn_lstm.py ../data/tr_st_reactions.csv ../data/tr_st_reactions.csv ../data/tr_tg_reactions.csv ../src_data/customer_test.csv ../data/all_story_id.txt ../data/tr_model_lstm.bin
#python learn_lstm.py ../data/vl_st_reactions.csv ../data/vl_st_reactions.csv ../data/vl_tg_reactions.csv ../src_data/customer_test.csv ../data/all_story_id.txt ../data/vl_model_lstm.bin
#python learn_lstm.py ../data/tt_st_reactions.csv ../data/tt_st_reactions.csv ../data/vl_tg_reactions.csv ../src_data/customer_test.csv ../data/all_story_id.txt ../data/tt_model_lstm.bin
...
#python train_catboost.py ../data/vl_features_$ver.txt ../data/vl_features_$ver.txt ../data/model_$ver.cbm 600
