...
CT_TRANSACTION_AMOUNT = 8 # OT_GLOBAL & OT_MCC
CT_TRANSACTION_AMOUNT_RATIO = 9 # OT_MCC, MCC:AMOUNT / GLOBAL:AMOUNT
CT_TRANSACTION_COUNT = 10 # OT_GLOBAL
CT_TRANSACTION_DATE = 11 # OT_GLOBAL
